...
async def convert_video(video_file, output_directory, total_time, bot, message, chan_msg):
    ...
    audio_b.append("40k")
    watermark.append('-vf drawtext=fontfile=font.ttf:fontsize=27:fontcolor=rgba(255,255,255,0):bordercolor=rgba(0,0,0,0):x=w-tw-10:y=10:box=1:boxcolor=rgba(0,0,0,0):boxborderw=6:text="Anikatsuki"
')
